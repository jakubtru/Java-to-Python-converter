...
public class SimpleJavaParser extends Parser {
	...
	public static final int
		...
		Equal=27, NotEqual=28, And=29, Or=30, Dot=31, Semicolon=32, Comma=33, 
		LeftParen=34, RightParen=35, LeftCurly=36, RightCurly=37, LeftSquareBracket=38, 
		RightSquareBracket=39, NewLine=40, IntegerLiteral=41, FloatLiteral=42, 
		CharLiteral=43, BoolLiteral=44, StringLiteral=45, Whitespace=46, Identifier=47;
	public static final int
		...
		RULE_declarationStatement = 10, RULE_statement = 11, RULE_assignmentStatement = 12, 
		RULE_printStatement = 13, RULE_ifStatement = 14, RULE_whileStatement = 15, 
		RULE_returnStatement = 16, RULE_expressionStatement = 17, RULE_expression = 18, 
		RULE_logicalExpression = 19, RULE_comparisonExpression = 20, RULE_mathExpression = 21, 
		RULE_unaryExpression = 22, RULE_primaryExpression = 23;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"And", "Or", "Dot", "Semicolon", "Comma", "LeftParen", "RightParen", 
			"LeftCurly", "RightCurly", "LeftSquareBracket", "RightSquareBracket", 
			"NewLine", "IntegerLiteral", "FloatLiteral", "CharLiteral", "BoolLiteral", 
			"StringLiteral", "Whitespace", "Identifier"
		};
	}
	...
	public final ClassBodyDeclarationContext classBodyDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 140737488357316L) != 0)) {
				{
				setState(70);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final MethodBodyContext methodBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 208924389652416L) != 0)) {
				{
				{
				setState(118);
				statement();
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(129);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 140737488357312L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 208924389539840L) != 0)) {
				{
				setState(191);
				expression();
				}
	...
	public final MathExpressionContext mathExpression() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_mathExpression);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
